...
public class RayTracer : MonoBehaviour
{
    ...
    private ComputeBuffer m_planesBuffer;
    private Plane[] m_planeData;
    ...
    public void NotifySceneChanged()
    {
        ...
        {
            m_sphereData = new Sphere[sphereObjects.Length];
            reallocate = true;
        }
